...
const CartItem = ({ onContinueShopping }) => {
  ...
  // Calculate total amount for all products in the cart
    ...
    let total = 0;
    cart.forEach(item => {
        const costNumber = parseFloat(item.cost.substring(1)); // Convert cost string like "$10.00" to number 10.00
        total += costNumber * item.quantity;
    });
    return total.toFixed(2); // Return total as a string fixed to 2 decimal places
    };
